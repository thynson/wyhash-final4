...
pub(crate) fn wy_read_tail8(input: &[u8]) -> u64 {
    match input.len() {
        ...
        1 => input[0] as u64,
        2 => wy_read_2(input),
        3 => (wy_read_2(input) << 8) | (input[2] as u64),
        4 => wy_read_4(input),
        5 => (wy_read_4(input) << 8) | (input[4] as u64),
        6 => (wy_read_4(input) << 16) | wy_read_2(&input[4..]),
        7 => (wy_read_4(input) << 24) | (wy_read_2(&input[4..]) << 8) | (input[6] as u64),
        8 => wy_read_8(input),
        _ => unreachable!(),
    }
}
